            ...
            try {
                ...
                akko.addVisualiser(new BarsVisualiser());
            ...
            try {
                console.log('Adding BarVisualiser...');
                akko.addVisualiser(new BarVisualiser());
                console.log('✅ BarVisualiser added');
            } catch (e) {
                console.error('❌ BarVisualiser failed:', e);
            }
            
            try {
                console.log('Adding RingVisualiser...');
                akko.addVisualiser(new RingVisualiser());
                console.log('✅ RingVisualiser added');
            } catch (e) {
            ...
            document.getElementById('playButton').addEventListener('click', function() {
                ...
                setTimeout(function() {
                    ...
                    try {
                        ...
                        akko.start();
                        console.log('Akko started.');
                    } catch (e) {
                        console.error('Error adding tracks or starting Akko:', e);
                    }
                }, 2000);
            });